classdef ZC < matlab.mixin.Copyable %handle
    ...
    methods (Static)
        ...
        function FILEstr = mat2DXstring(densityMatrix, varargin)
            % this function outputs a DX file for viewing in VMD or PyMOL. It uses
            % six inputs to function properly (subvariables of "DXdata"). While only
            % one is necessary (the 3D matrix called "densityMatrix"), the others shape
            % and position the 3D matrix in space. A minimum point and a voxel length
            ...
            % output header information
            headerLine1 = sprintf('object 1 class gridpositions counts%8.0f%8.0f%8.0f\n', ...
                dimen(1), dimen(2), dimen(3));
            
            headerLine2 = sprintf('origin%16g%16g%16g\n', minX, minY, minZ);
            
            headerLine3 = sprintf('delta%16g 0 0\n', voxelLength);
            
            headerLine4 = sprintf('delta 0 %16g 0\n', voxelLength);
            
            headerLine5 = sprintf('delta 0 0 %16g\n', voxelLength);
            
            headerLine6 = sprintf('object 2 class gridconnections counts%8.0f%8.0f%8.0f\n', ...
                dimen(1), dimen(2), dimen(3));
            
            headerLine7 = sprintf('object 3 class array type double rank 0 items  %g data follows\n', ...
                totalElements);
            
            FILEstr = [headerLine1 headerLine2 headerLine3 headerLine4 headerLine5 headerLine6 headerLine7];
            
            % output density information
            newLine = 0;
            for n = 1:numRows
                line_n = sprintf('%16E%16E%16E\n',out3DMat(n,:));
                FILEstr = [FILEstr line_n];
            ...
            if overFlowVals > 0 % values not in complete row
                for n = 1:overFlowVals
                    line_n = sprintf('%16E',densityMatrix(end-n+1));
                    FILEstr = [FILEstr line_n];
                end
                FILEstr = [FILEstr '\n'];
            end
            ...
            % output file tail
            tailLine = sprintf(['attribute "dep" string "positions"\n' ...
                'object "regular positions regular connections" class field\n' ...
                'component "positions" value 1\n' ...
                'component "connections" value 2\n' ...
                'component "data" value 3\n']);
            
            FILEstr = [FILEstr tailLine];
